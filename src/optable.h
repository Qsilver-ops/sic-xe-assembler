...
public:
  optable();
  int getOpcode(std::string s);
  int getInstructionFormat(std::string s);

private:
  std::unordered_map<std::string, std::pair<unsigned int, int>> table = {
      ...
      {"MUL", {0x20, 3}},   {"MULF", {0x60, 3}},  {"MULR", {0x98, 2}},
      {"NORM", {0xC8, 1}},  {"OR", {0x44, 3}},    {"RD", {0xD8, 3}},
      {"RMO", {0xAC, 2}},   {"RSUB", {0x4C, 3}},  {"SHIFTL", {0xA4, 2}},
      {"SIO", {0xF0, 1}},   {"SSK", {0xEC, 3}},   {"STA", {0x0C, 3}},
      {"STB", {0x78, 3}},   {"STCH", {0x54, 3}},  {"STF", {0x80, 3}},
      {"STI", {0xD4, 3}},   {"STL", {0x14, 3}},   {"STS", {0x7C, 3}},
      {"STSW", {0xE8, 3}},  {"STT", {0x84, 3}},   {"SUB", {0x1C, 3}},
      {"SUBF", {0x5C, 3}},  {"SUBR", {0x94, 2}},  {"SVC", {0xB0, 2}},
      {"TD", {0xE0, 3}},    {"TIO", {0xF8, 1}},   {"TIX", {0x2C, 3}},
      {"TIXR", {0xB8, 2}},  {"WD", {0xDC, 3}},    {"JSUB", {0x48, 3}},
      {"SHIFTR", {0xA8, 2}},{"STX", {0x10, 3}}
